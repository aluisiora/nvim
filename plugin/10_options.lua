...
vim.o.pumborder      = 'none'     -- No borders in popup menu
...
vim.o.winborder      = 'none'     -- No borders in floating windows
...
vim.api.nvim_create_autocmd("FileType", {
  group = vim.api.nvim_create_augroup("mini-nowrap", { clear = true }),
